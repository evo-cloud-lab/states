...
var States = Class(process.EventEmitter, {
     ...
     *
     * Query returns results in 4 cases:
     *    - key == null, node == null
     *        return all data, { d: { keys: [...], nodes: [...], vals: [...] }, r: rev }
     *        in this case, vals maps to cartesian product of keys and nodes
     *    - key == null, node != null
     *        return values of the specified node, { d: { key1: val1, key2: val2 }, r: node's rev }
     *    - key != null, node == null
     *        return values of the specified key, { d: { node1: { d: val1, r: node's rev }, }, r: rev }
     *    - key != null, node != null
     *        return a single entity { d: val, r: node's rev }
     */
    ...
    _invoke: function (method) {
        this._logger.debug('INVOKE ' + this.mode + ':' + method);
